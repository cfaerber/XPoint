{   $Id: xp4o.pas,v 1.169 2004/01/18 19:58:38 mk Exp $
...
//  if Replyto <> '' then apps(9,LeftStr(replyto,53));
    ...
    apps(16,typstr(typ,mime.contenttype.verb));
...
{
  $Log: xp4o.pas,v $
  Revision 1.169  2004/01/18 19:58:38  mk
  - changed ^file to file

  Revision 1.168  2004/01/18 15:06:12  mk
  - use WildCard instead of * or *.*

  Revision 1.167  2004/01/17 16:33:44  mk
  - split xp0.pas in xp0.pas and xpconst.pas to remove some dependencies
    xpconst.pas should be used for global constants (only!)

  Revision 1.166  2003/11/09 14:35:12  mk
  - fixed access of false ressources while /Wartung/Komplett in CompleteMaintainance

  Revision 1.165  2003/11/02 12:07:06  cl
  - BUGFIX: range check error during reorganisation with defective database,
    see <news:8x4D6qprpVB@centermail.net>

  Revision 1.164  2003/10/21 21:25:04  cl
  ...
  Revision 1.145  2002/08/01 20:46:46  mk
  ...
  -Spezialsuche in markierten Bretter auch aus der Nachrichten/User Übersicht
