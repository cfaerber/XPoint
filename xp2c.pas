...
end.
{
  ...
  MY: Tausendundeins Korrekturen, ƒnderungen und Erg‰nzungen, speziell in XP.IHQ
      (u.a. f¸r C/O/V, neue Topics f¸r Kommandozeilen-Parameter, Standard-Mailer
      unter Windows und Mailinglisten)
  MY: in xp2c.pas nur kleine Layoutkorrektur (¸bernommen von JG in 3.30)
