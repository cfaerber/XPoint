...
begin
  ...
  maddbool(3,11,getres2(252,17),SaveUVS);   { 'unversandte Nachrichten nach /ØUnversandt' }
...
var x,y,i,j : byte;
    brk : boolean;
begin
  dialog(41,12,getres2(260,11),x,y);
  ...
  maddbool(3,11,getres2(260,7),soundflash);   { 'optisches Tonsignal' }
  freeres;
  readmask(brk);
  if not brk and mmodified then begin
...
var x,y : byte;
    ...
    i   : integer;
begin
  dialog(58,2*maxviewers+1,getres(266),x,y);   { 'Anzeige-Programme fÅr ...' }
