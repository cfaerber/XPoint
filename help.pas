...
begin
  if ioresult<>0 then begin
    attrtxt(7);
    writeln;
    writeln('<HELP> Fehler: Hilfsdatei '+ustr(filename(f))+' ist beschÑdigt.');
    halt(1);
    end;
end;
...
{
  $Log$
  Revision 1.5.2.1  2000/10/09 22:12:12  mk
