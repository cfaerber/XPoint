...
const
      ...
      orglen      = 80;
      adrlen      = 80;
      realnlen    = 70;           { 11.10.1999 robo - Realname verlÑngert }
      hderrlen    = 60;
      maxemp      = 50;
...
type  OrgStr  = string[orglen];
      ...
      header  = record
                  ...
                  betreff    : string[250];   { verlÑngert wegen MIME-Codierung }
                  absender   : string[80];
...
{                  realname   : string[40]; }
                  ...
                  { 11.10.1999 robo - Realname verlÑngert wg. MIME }
...
{ 28.01.2000 robo - Envelope-EmpfÑnger }
...
{ ist zwar nicht unbedingt nîtig, aber sauberer }
  begin
...
{ 28.01.2000 robo - Fix fÅr QP-Dekodierung }
    repeat
      p1:=pos('=?',ss);
...
{ 11.10.1999 robo - Fix im Zuge der RealnameverlÑngerung }
