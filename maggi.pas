...
const nt_ZConnect=2;
      ...
      OldXPComp : boolean = false; { XP 3.12 KompatibilitÑt: F-TO -> X-XP-FTO }
...
begin
  ...
  writeln('    -g   =  GS-Mailbox                 -312 =  KompatibilitÑtsmodus zu 3.12');
  halt(1);
end;
...
{
  $Log$
  Revision 1.15.2.15  2003/05/01 14:22:33  mk
