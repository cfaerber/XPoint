{   $Id: xp1.pas,v 1.202 2004/01/18 15:01:36 mk Exp $
...
{$ENDIF }
  ...
  resource,crc,debug,  osdepend, xpconst,
...
{
  $Log: xp1.pas,v $
  Revision 1.202  2004/01/18 15:01:36  mk
  - use ExcludeTrailingPathDelimiter instead of ExcludeTrailingBackslash

  Revision 1.201  2004/01/17 16:33:41  mk
