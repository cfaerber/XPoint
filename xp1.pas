...
end.
{
  ...
  MY:- Fix: Farben fÅr Statuszeile und Suchergebnis in Select-Box
       initialisiert (relevant fÅr Suchbegriffs-Bibliothek).
  ...
  JG+MY:- Brettmanager: Text-Markiersuche mit "S" (analog zu Lister),
          ...
          Suchfunktionen jetzt Åber <Ctrl-S> (frÅher "S") bzw. wie bisher
          Åber <Shift-S> erreichbar.
