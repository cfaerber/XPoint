...
{
  $Log$
  Revision 1.40.2.33  2003/05/01 14:22:41  mk
  ...
  JG+MY:- Dateinamenabfrage: Letzter benutzter Pfad (ohne Dateinamen) wird
          ...
          werden gespeichert auch wenn keine Datei ausgewÑhlt wurde, bei
          PfadÑnderungen in der Datei-Auswahlbox und anschlie·ender
          Dateiauswahl werden Pfad und Wildcard fÅr die nÑchste <F2>-
          Auswahl gespeichert.
  ...
  - Overwrite liefert false, wenn Datei schreibgesch¸tzt
  ...
  JG: * Umlautkonvertierung von XP4O.Betreffsuche in Typeform verlagert
      ...
      * Die Suchfunktionen "Absender/User", "Betreff" und "FidoempfÑnger"
        kînnen jetzt umlautunabhÑngig geschaltet werden
