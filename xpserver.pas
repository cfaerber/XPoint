{ $Id: xpserver.pas,v 1.8 2003/10/18 17:14:50 mk Exp $
...
{ -- Creating -------------------------------------------------------- }
  protected
    constructor Create(d: DB);

  public
    class function CreateByDB: TXPServer; overload;
    class function CreateByDB(d: DB): TXPServer; overload;
    class function CreateByName(const name: string): TXPServer;
    class function CreateByFileName(const name: string): TXPServer;
...
class function TXPServer.CreateByDB: TXPServer;
begin
  result := CreateByDB(BoxBase);
end;

class function TXPServer.CreateByDB(d: DB): TXPServer;
var flags : byte;
  F_Netztyp : RNetzMsg;
begin
(*
...
*)
    result := TXPServer.Create(d);
(*
  end;
*)  
end;

class function TXPServer.CreateByName(const name: string): TXPServer;
begin
...
class function TXPServer.CreateByFileName(const name: string): TXPServer;
begin
