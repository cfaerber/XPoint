{   $Id: xpstat.pas,v 1.58 2004/01/17 16:33:49 mk Exp $
...
uses xp3,xp3o,xp3o2,xpsendmessage,xp9bp,xpconfigedit,xpnt,xpfidonl,xpconst,winxp;
...
begin
  ...
  smax:=min(sysmax, maxrec); { Nur bis Anzahl der gewÑhlten Systeme }
...
{
  $Log: xpstat.pas,v $
  Revision 1.58  2004/01/17 16:33:49  mk
