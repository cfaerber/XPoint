...
{
  $Log$
  Revision 1.6.2.10  2003/05/01 14:23:00  mk
  ...
  JG+MY:- Konfigurierbare Funktionstasten (<Shift-F1> etc.) unterstÅtzen
          jetzt das Makro $ASK, das einen Eingabedialog ausfÅhrt, mittels
          dessen dem auszufÅhrenden Programm einer oder mehrere Parameter
          Åbergeben werden kînnen (z.B. URL aus Lister kopieren und mit
          Browser starten).
