{   $Id: xpkeys.pas,v 1.33 2004/01/17 16:33:48 mk Exp $
...
uses xp4o,xpnetcall,xpconfigedit,xpauto,xpconst, clip;
  ...
  begin
    ...
    begin
      ...
      if copy(s,2,8)='RNETCALL' then
        netcall2(true,trim(copy(s,11,BoxNameLen)),false,true,false) else
...
{
  $Log: xpkeys.pas,v $
  Revision 1.33  2004/01/17 16:33:48  mk
