...

{
  ...
  MY:- Taste fÅr "Parken" im Editor wird jetzt aus Ressource ausgelesen
  ...
  MY:- Fix: Wenn wÑhrend des Editierens einer Nachricht mit <Alt-E> eine
       ...
       Button, falscher Dialog "Datei wurde geÑndert").
  ...
  JG+MY:- Beim Editieren von Nachrichten gibt es im "ƒnderungen
