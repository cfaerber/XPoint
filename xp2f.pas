...
{$IFDEF ver32}
procedure sdisp(x,y:word; var s:string); begin end;
{$ELSE}
procedure sdisp(x,y:word; var s:string); near; external;
{$L xp2f.obj}
{$ENDIF}
...
procedure wwin(l,r,o,u:byte; txt:string; rahmen,text:byte); far;
begin
