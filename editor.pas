{   $Id: editor.pas,v 1.101 2004/01/17 16:33:40 mk Exp $
...
{
  $Log: editor.pas,v $
  Revision 1.101  2004/01/17 16:33:40  mk
  - split xp0.pas in xp0.pas and xpconst.pas to remove some dependencies
    xpconst.pas should be used for global constants (only!)

  Revision 1.100  2003/10/27 12:57:31  cl
  - fixed IO error (cause is somewhere else, IOResult was set to non-zero)
