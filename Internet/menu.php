...
$Menu = array(
	...
	5 => array("de"	=> "OpenXP/16",
		"en" 	=> "OpenXP/16",
		"sub"	=> false),
	6 => array("de"	=> "FAQ",
		"en" 	=> "FAQ",
		"url"	=> $indexname . "?news=faq16-de.txt&genindex=1",
		"sub"	=> true),
	7 => array("de"	=> "Download",
		"en" 	=> "Download",
		"url"	=> $indexname . "?file=download16-" . $language . ".html",
		"sub"	=> true),
	8 => array("de"	=> "Logs (v3.20)",
		"en" 	=> "Logs",
		"url"	=> $indexname . "?file=log320.html",
		"sub"	=> true),
	9 => array("de"	=> "Logs (v3.40)",
		"en" 	=> "Logs",
		"url"	=> $indexname . "?file=log340.html",
		"sub"	=> true),

	10 => array("de"	=> "OpenXP/32",
		"en" 	=> "OpenXP/32",
		"sub"	=> false),
	11 => array("de"	=> "FAQ",
		"en" 	=> "FAQ",
		...
		"sub"	=> true),
	12 => array("de"	=> "Setup-Infos",
		"en" 	=> "Infos for setup",
		"url"	=> $indexname . "?file=setup32-de.html",
		"sub"	=> true),
	13 => array("de"	=> "Download",
		"en" 	=> "Download",
	...
	16 => array("de"	=> "Entwicklerinfos",
		"en" 	=> "Developer info",
		"url"	=> $indexname . "?file=code-" . $language . ".html",
		"sub"	=> false),
	17 => array("de"	=> "Hinweise",
		"en" 	=> "Hints",
