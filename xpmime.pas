{   $Id: xpmime.pas,v 1.69 2003/10/21 21:25:04 cl Exp $
...
begin                         { SelectMultiPart }
  ...
  if not forceselect and (PartsList.Count=3) and (TMimePart(PartsList[1]).typ='text')
     ...
     and (((Lowercase(hdp.mime.contenttype.verb)='multipart/alternative')  { Text+HTML Messis }
...
{
  $Log: xpmime.pas,v $
  Revision 1.69  2003/10/21 21:25:04  cl
  ...
  Revision 1.61  2002/06/29 13:54:00  mk
