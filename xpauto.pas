{   $Id: xpauto.pas,v 1.73 2004/01/17 16:33:47 mk Exp $
...
uses
  montage,typeform,fileio,datadef,database,resource, xpconst,
...
{ In auto muá korrekter Datensatz sein! }
...
//      sdata:= TSendUUData.Create;
        ...
        begin
          ...
          orghdp.mime.Contenttype.AsString := ctype;
