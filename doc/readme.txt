     ...
     Entwicklung der Version 3.20 wurde schon 1997 begonnen, eine
     offizielle Version nach v3.12 wurde allerdings von Peter Mandrella
     selbst nie verîffentlicht.

     Das OpenXP-Team legt mit OpenXP 3.20d nach fast genau einjÑhriger
     Arbeit, etlichen Betaversionen, "Release Candidates" und der ersten
     Release v3.20 die (voraussichtlich) endgÅltige und letzte Release
     der Version 3.20 vor. Sie enthÑlt nur wenige neue Features im
     Vergleich zur Ur-Version 3.20, dafÅr aber eine um so grî·ere
     (dreistellige) Zahl von Bugfixes. StabilitÑt ist oberstes Gebot bei
     dieser Version.
     ...
     CrossPoint/OpenXP liegt darÅber hinaus bereits in einer Beta-
     Version 3.30 (16-bit) vor, von der demnÑchst der erste "Release
     Candidate v3.40" erscheinen wird. OpenXP v3.30 zeichnet sich neben
     ebenfalls hoher StabilitÑt durch eine ganze Reihe neuer Features
     aus.
     ...
     In den Dateien SLIZENZ.TXT und LIZENZ.DOC befinden sich Peter
     Mandrellas Hinweise zur Verwendung des Quelltextes und weitere
