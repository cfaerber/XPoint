{   $Id: xpimpexp.pas,v 1.55 2004/01/17 16:33:48 mk Exp $
...
type  MsgITyp   = xpWord;
      ...
      Msg_Index = RECORD
                    ...
                    MsgSize: xpWord;   { Msg-Grî·e in Bytes }
                    DIndex: LongINT;
                    KommentarZu,
                    Antwort,
                    RechteAntwort,
...
{
  $Log: xpimpexp.pas,v $
  Revision 1.55  2004/01/17 16:33:48  mk
  ...
  Revision 1.48  2002/07/21 20:23:24  ma
