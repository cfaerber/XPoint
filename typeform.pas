...
Function fitpath(path:string; n:byte):pathstr;   {+ Pfad evtl. abkÅrzen    }
...
{
  $Log$
  Revision 1.37.2.32  2003/05/01 14:22:35  mk
  ...
  MY:- Fix Archiv-Viewer: Wenn die zu entpackende Datei bereits vorhanden
       und der Dateiname lÑnger war als die in der Fehlermeldung "xyz
       existiert schon. öberschreiben?" darzustellende (und daher zu
       kÅrzende) LÑnge des Dateinamens, dann hing XP in einer
       Endlosschleife fest. Der Name wird jetzt in der Reihenfolge
       Erweiterung, Pfad, Dateiname gekÅrzt. Dieser Fix betrifft auch alle
