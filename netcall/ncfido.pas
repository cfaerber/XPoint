{  $Id: ncfido.pas,v 1.16 2004/01/25 19:38:34 cl Exp $
...
begin
  ...
  if UseBinkP then begin // BinkP mailer
    ...
    for iTimer:=0 to qTimers-1 do Timers[iTimer] := TTimer.Create;
...
{
  $Log: ncfido.pas,v $
  Revision 1.16  2004/01/25 19:38:34  cl
  ...
  Revision 1.15  2003/08/28 00:17:00  mk
  - SchaltJ() -> IsLeapYear()
