{ $Id: zmodem.pas,v 1.34 2003/09/21 21:45:58 mk Exp $
...
begin
  MakeCRC32 := TRUE; RecoverAllow := TRUE; LastSent:=0; ElapsedSec := TTimer.Create;
...
begin
  TimerObj := TTimer.Create; LogTimer := TTimer.Create;  FileAddition:=RecoverFile;
