{  $Id: ncuucp.pas,v 1.33 2003/08/28 18:54:29 cl Exp $
...
uses
  classes,
  timer,
  objcom, ncmodem, netcall, xpprogressoutputwindow;
...
type TUUCProtocol = class
  ...
  protected
    ...
    property    TimerObj: TTimer      read FTimerObj;
...
const InitTimeout   =   5;    { g: Repeat-Timeout bei INIT-Packets      }
      ...
      DataTimeout  =   60;    { g: Timeout bei Uebertragung eines Datenpakets }
...
{$IFDEF DOS32} xpdos32, {$ENDIF}
  ...
  xpdiff, fileio, inout, keys, xpnetcall, ipaddr,
  ncuucp_e, ncuucp_fz, ncuucp_g, ncuucp_t,
  xpglobal;
...

{
  ...
  Revision 1.28  2002/12/09 14:37:23  dodi
