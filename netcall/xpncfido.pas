  ...
  begin
    ...
    if files<>'' then
      ...
      begin
        ...
        nfiles:=trim(nfiles);
        if nfiles<>'' then
          nfiles:='>'+nfiles;   { Requests zurueckstellen }
