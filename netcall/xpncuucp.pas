{  $Id: xpncuucp.pas,v 1.24 2004/01/17 16:33:53 mk Exp $
...
uses
  xp3,xpmakeheader,xpprogressoutputwindow,xpmodemscripts,  xpconst,
...
//    MakeMimetypCfg;
  ...
  begin
    ...
    if BoxPar^.conn_mode in [2,3] then
    begin
      UUCICO.Host := BoxPar^.Conn_IP;
      UUCICO.Port := BoxPar^.Conn_Port;
    end else
...
{
  $Log: xpncuucp.pas,v $
  Revision 1.24  2004/01/17 16:33:53  mk
