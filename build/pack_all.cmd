...
rmdir \source\openxp_4.10 /s /Q
svn export \svn\openxp_4.10 c:\source\openxp_4.10

echo Erstelle Versions-Informationen
cd \svn\openxp_4.10\build
\perl\bin\perl get_build_nr.pl >\temp\variables.cmd
call \temp\variables.cmd
copy \svn\openxp_4.10\build\version.inc \source\openxp_4.10
del version.inc
echo Version: %OXP_VER%
echo Options: %OXP_OPTS%

cd \source\openxp_4.10
...
cd \source
xparchiv\docform openxp_4.10\doc\fido.dq xpd_370d\doc\fido.txt 68 8
xparchiv\docform openxp_4.10\doc\uucp.dq xpd_370d\doc\uucp.txt 68 8
copy xpd_370d\doc\fido.txt xpd_370w\doc
copy xpd_370d\doc\uucp.txt xpd_370w\doc

echo Compiliere Hilfe
xparchiv\ihs_38 openxp_4.10\doc\openxp-d xpd_370d
xparchiv\ihs_38 openxp_4.10\doc\openxp-e xpd_370d
copy xpd_370d\openxp*.hlp xpd_370w

echo Compiliere Hilfe
xparchiv\rc_38 openxp_4.10\openxp-d xpd_370d
xparchiv\rc_38 openxp_4.10\openxp-e xpd_370d
copy xpd_370d\openxp-?.res xpd_370w

echo Packe Sourcen
cd \source\openxp_4.10
copy \svn\openxp_4.10\build\file_id.source file_id.diz
