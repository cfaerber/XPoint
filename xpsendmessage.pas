{ $Id: xpsendmessage.pas,v 1.48.2.23 2004/01/18 19:21:48 mk Exp $
  ...
  if (_bezug<>'') and ntKomkette(netztyp) and
    ...
    if not ReadJNesc(getres(617),(leftstr(betreff,5)=leftstr(oldbetr,5)) 
       or ((cpos('(',oldbetr)=0) and (cpos('(',betreff)>0)),brk) then
          { 'Betreff geÑndert - Verkettung beibehalten' }
    begin
      _bezug:='';
      _orgref:='';
...

{
  ...
  - fixed #801901: Sendefenster ˆffentl. Nachricht FIDO
  ...
  - FIX: [ 497544 ] Sendefenster: Empf‰nger ‰ndern (32bit):
