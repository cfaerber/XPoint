{  $Id: xpterminal.pas,v 1.15 2002/12/21 05:38:03 dodi Exp $
...
const ansimax  = 40;       { max. LÑnge von ANSI-Codes }
var   log2     : textp   = nil;
...
begin
  ...
  begin
    tfehler(ObjCom.ErrorStr,30); // Das GerÑt kann nicht angesprochen werden!
    freeres;
    exit;
  end;
