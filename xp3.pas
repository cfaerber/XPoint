...
@Lookup: db 'ABCDEFGHIJKLMNOPQRSTUVWXYZ{|}~'
         db 'ÄöEÉéÖÜáàâäãåçéèEëíìôïñóòôöõúùûüAIOU§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø'
         db '¿¡¬√é≈∆«»E ÀÃÕŒœ–—“”‘’ô◊ÿŸ⁄€ö›ﬁ·‡·‚„éÂÊÁËEÍÎÏIÓÔÒÚOÙıô˜¯˘U˚ö˝˛ˇ'
...
{
  $Log$
  Revision 1.25.2.18  2003/05/01 14:22:44  mk
  ...
  JG:- Volltextsuche korrigiert;
       - Wildcard-Suche zunÑchst wieder auf alten Stand (nicht mehr
         wortÅbergreifend, sondern nur innerhalb eines Wortes)
         zurÅckgesetzt (TemporÑrfix, bis Routine neu geschrieben wird).
       - Umlaute (Ñ,î,Å,·) werden jetzt auch in Nachrichten mit
