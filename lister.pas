...
{
  $Log$
  Revision 1.19.2.16  2003/05/01 14:22:32  mk
  ...
  JG [+MY]:- Lister kann jetzt Dateien/Nachrichten bis 64 Megabyte
             ...
             1. Konstante 'XmsPagesize' von 4096 auf 32768 Bytes
                vergrî·ert, dadurch bisheriges internes Limit von 4096
                Blîcken † 4096 Bytes (= 16 Megabyte) aufgehoben.
             2. Kalkulation des erforderlichen verfÅgbaren unteren
                Speichers zum Anfordern von XMS auf sinnvollen Wert
                angepa·t (bisher: 2*XmsPagesize, jetzt: XmsPagesize+4096).
             3. In Verbindung mit der jetzt korrekten Ermittlung des
                verfÅgbaren XMS unter Windows 9x (s. XMS.ASM) kann der
                ...
                Megabyte.
             4. Damit ist gleichzeitig sichergestellt, da· Brettlisten von
                Boxen des Netztyps RFC/Client, die vor dem Laden in den
                Lister eine interne Konvertierung durchlaufen und dadurch
                hÑufig auf mehr als das Doppelte ihrer eigentlichen Grî·e
                anwachsen, immer vollstÑndig geladen werden.
             5. Unter Windows NT/2000/XP liegt das Limit aufgrund der
                BeschrÑnkungen seitens des Betriebssystems weiterhin bei
                16 Megabyte.
  ...
  MY:- Bei der Anzeige von Dateien im internen Lister wird der Dateiname
       ...
       (UnabhÑngig von der Einstellung C/O/L/Rollbalken_bei_Mausbedienung)
