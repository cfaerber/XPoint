{ $Id: uuzng_rfc_uucp.pas,v 1.2 2003/10/21 21:22:42 cl Exp $
...
function Get: TXPMessage;
begin
  result := nil;
end;

//
// $Log: uuzng_rfc_uucp.pas,v $
// Revision 1.2  2003/10/21 21:22:42  cl
// - UUZNG update
//
end.
