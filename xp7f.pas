    ...
    if exist(XFerDir+'*.PKT') then begin
      ...
      if errorlevel<>0 then
        ...
        if nDelPuffer then
          ...
          findfirst(XFerDir+'*.pkt',0,sr);    { .PKT - Dateien lîschen  }
...
{
  $Log$
  Revision 1.5.2.2  2003/01/15 16:02:15  mw
  ...
  Revision 1.5.2.1  2000/04/24 19:35:18  mk
  JG: Fix: Fido/Crash...markiert: Menuezeilen wurden wie Nodes behandelt
