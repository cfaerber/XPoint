{   $Id: xp9bp.pas,v 1.71 2004/01/17 16:33:46 mk Exp $
...
//  pop3_clear := true;                 { POP3: Nachrichten loeschen }
    ...
    pop3_LeaveOnServer := true;         { POP3: Nachrichten auf Server lassen }
    pop3_DeleteAfterDays := 0;          { POP3: Nach n Tagen löschen }
    pop3_DeleteAfterLocal := true;      { POP3: Löschen, wenn aus Datenbank gelöscht }
    pop3_EnvelopeTo := '';              { POP3: Empfängerbrett }
...
//          getx(su,  'POP3Clear', pop3_clear) or
            ...
            GetX(su,  'POP3-LeaveOnServer', pop3_LeaveOnServer) or
            GetI(su,  'POP3-LeaveOnServer-DeleteAfterDays', pop3_DeleteAfterDays) or
            GetX(su,  'POP3-LeaveOnServer-DeleteAfterLocalDelete', pop3_DeleteAfterLocal) or
            Gets(s,su,'POP3-EnvelopeTo', pop3_EnvelopeTo) or
...
//    writeln(t,'POP3Clear=',jnf(pop3_clear));
      writeln(t,'POP3-LeaveOnServer=',jnf(pop3_LeaveOnServer));
      writeln(t,'POP3-LeaveOnServer-DeleteAfterDays=', pop3_DeleteAfterDays);
      writeln(t,'POP3-LeaveOnServer-DeleteAfterLocalDelete=', jnf(pop3_DeleteAfterLocal));
      writeln(t,'POP3-EnvelopeTo=', pop3_EnvelopeTo);
