{   $Id: xp9bp.pas,v 1.61.2.4 2003/04/03 13:33:45 mk Exp $
...
{
  $Log: xp9bp.pas,v $
  Revision 1.61.2.4  2003/04/03 13:33:45  mk
  - POP3 and SMTP-Port is now configurable in *.bfg

  Revision 1.61.2.3  2002/07/31 19:30:36  ma
  - new feature: kill/prevent dupes when sorting in messages
    (in fact a replaceown variant)
    taken from v3.9

  Revision 1.61.2.2  2002/07/21 20:14:38  ma
  - changed copyright from 2001 to 2002

  Revision 1.61.2.1  2002/07/16 22:13:53  ma
